...
class PagoController extends Controller
{
    ...
    public function datoimp(Request $request){
        ...
        $datos=DB::SELECT("SELECT a.nombres,a.apellidos,a.estado,v.codmovil ,a.fechaing,a.telefono,v.id,v.placa,g.tipo ".$cad."
        ...
        group by a.nombres,a.apellidos,a.estado,v.codmovil,a.fechaing,a.telefono,v.id,v.placa,g.tipo");
        return $datos;
    }
