...
class ReportController extends Controller
{
    ...
    public function repAsistencia($fecha){
        $asist= DB::SELECT("SELECT a.* from afiliados a inner join asistencias s on a.id=s.afiliado_id where date(s.fecha)='$fecha' group by a.* order by cast(a.codigo as unsigned)");
